...
public class StaffRepository {
    ...
    public void InsertTask(final Staff staff){
        new AsyncTask<Void,Void,Void>(){
            ...
            protected Void doInBackground(Void... voids) {
                staffDatabase.staffDAO().insert(staff);
                return null;
            }
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                Toast.makeText(context, staff.getFname() + " is inserted", Toast.LENGTH_SHORT).show();
            }
        }.execute();
    }
    //end insert
    ...
    public List<Staff> getStaff(){
        ...
        return staffDatabase.staffDAO().getAllStaff();
    }
    //end get
    ...
    public void UpdateTask(final Staff staff){
        new AsyncTask<Void,Void,Void>(){
            ...
            @Override
            protected Void doInBackground(Void... voids) {
                staffDatabase.staffDAO().update(staff);
                return null;
            }
            ...
            protected void onPostExecute(Void aVoid) {
                super.onPostExecute(aVoid);
                Toast.makeText(context,staff.getFname()+" is updated",Toast.LENGTH_SHORT).show();
            }
        }.execute();
    }
    //end update
    ...
    public void DeleteTask(final Staff staff){
        new AsyncTask<Void,Void,Void>(){
            ...
            @Override
            protected Void doInBackground(Void... voids) {
                staffDatabase.staffDAO().delete(staff);
                return null;
            }
            ...
            protected void onPostExecute(Void aVoid) {
                super.onPostExecute(aVoid);
                Toast.makeText(context,staff.getFname()+" is deleted",Toast.LENGTH_SHORT).show();
            }
        }.execute();
    }
    //end delete
